		...
		<div className="bg-gray-100">
			<div className="w-full text-white bg-main-color">
				<div x-data="{ open: false }"
					...
					<div className="{'flex': open, 'hidden': !open}' flex-col flex-grow pb-4 md:pb-0 hidden md:flex md:justify-end md:flex-row">
						<div className="relative" x-data="{ open: false }">
							<button
								...
								<svg fill="currentColor" viewBox="0 0 20 20" className="{'rotate-180': open, 'rotate-0': !open} inline w-4 h-4 transition-transform duration-200 transform">
									<path
										fill-rule="evenodd"
