...
const Profile = () => {
	...
	return (
    <div className="h-screen flex flex-wrap flex-col bg-white/75 dark:bg-slate-800 border-8 border-white/75 text-center">
      <div className="flex flex-row border-8 border-white/75 dark:border-slate-800 space-x-4 space-y-4">
        <div className=''>
          <img
