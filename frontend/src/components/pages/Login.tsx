...
const Login: React.FC<Props> = ({setIsAuth, isAuth, state}) => {
    const handleLogin = () => {
        ...
        const url_auth_42 = `https://api.intra.42.fr/oauth/authorize?client_id=${client_id_42}&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2F&response_type=code&state=${generatedState}`;
