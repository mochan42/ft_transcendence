...
const PvP: React.FC<PvPProps> = ({ userId, difficulty, isGameActive, isGameOver, isReset, playerScore, botScore, includeBoost, playerPoint, botPoint, setIsGameOver, setReset }) => {
